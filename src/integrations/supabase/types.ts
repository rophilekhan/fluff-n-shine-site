  ...
  public: {
    Tables: {
      bookings: {
        ...
        Relationships: [
          {
            foreignKeyName: "bookings_delivery_time_slot_id_fkey"
          ...
          {
            foreignKeyName: "bookings_pickup_time_slot_id_fkey"
            columns: ["pickup_time_slot_id"]
            isOneToOne: false
            referencedRelation: "time_slots"
            referencedColumns: ["id"]
          },
